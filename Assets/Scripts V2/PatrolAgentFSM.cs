...
public class PatrolAgentFSM : NaiveFSM
{
    ...
    public AudioSource NotDetectedMusic;
    public AudioSource DetectedMusic;
    ...
    {
         player = GameObject.Find("Ghost"); // Assuming the player's GameObject is named "Player"
        //_Renderer = GetComponent<MeshRenderer>();
        _PlayerGameObject = GameObject.Find("Ghost");
    ...
    public void PlayNotDetectedMusic()
    {
        AttackMusic.Stop();
        DetectedMusic.Stop();
        NotDetectedMusic.Play();
        NotDetectedMusic.loop = true;   
    }
    ...
    {
        AttackMusic.Stop();
        NotDetectedMusic.Stop();
        DetectedMusic.Play();
        DetectedMusic.loop = true;
